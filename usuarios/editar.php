        ...
        <div class="content">
            <div class="card">
                <div class="header">
                    ...
                    <p>Modifica la información registrada de este usuario</p>
                </div>
...
?>
                ...
                <form method="POST" action="update.php">
                    ...
                    <input type="hidden" id="id" name="id" value="<?php echo htmlspecialchars($usuario['id']); ?>">
                    ...
                    <div class="info-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" id="password" name="password" placeholder="Sólo si deseas cambiarla..." value="<?php echo htmlspecialchars($usuario['password']); ?>" required>
                        </div>
                        
                        <div class="form-group" style="display: flex; align-items: center;">
                            <div class="checkbox-group">
                                <input type="checkbox" id="es_admin" name="es_admin" value="1" <?php echo($usuario['es_admin'] == 1) ? 'checked' : ''; ?>>
                                <label for="es_admin">Privilegios de Administrador</label>
                            </div>
                        </div>
                    </div>
