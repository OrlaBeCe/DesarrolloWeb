        ...
        <div class="content">
            <div class="card">
                <div class="header">
                    ...
                    <p>Modifica la información de este producto</p>
                </div>
                ...
                <form method="POST" action="update.php">
                    ...
                    <input type="hidden" id="id" name="id" value="<?php echo htmlspecialchars($producto['Id']); ?>">
                    ...
                    <div class="form-buttons">
                        ...
                        <button type="button" class="btn-cancelar" onclick="window.location.href='index.php'"><i
